...
var currentStatsUpdate = function currentStatsUpdate() {
    ...
    htmlForCurrentStats += '<td style="width: 33%; text-align: left">infoTouch by jfabi</td>'
    if (currentTime.getSeconds() % 10 < 5) {
        ...
        htmlForCurrentStats += '<td style="width: 34%; text-align: center">' + hour + ':' + minute + '</td>'
        ...
        htmlForCurrentStats += '<td style="width: 34%; text-align: center">' + daysOfWeek[dayOfWeek] + ' ' + dayOfWeek + '</td>'
        tempString = currentTempF + '&deg;F'
    }

    htmlForCurrentStats += '<td style="width: 33%; text-align: right">' + tempString + ' ' + currentWeather + '</td>'
